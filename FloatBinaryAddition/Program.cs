...
namespace FloatBinaryAddition
{
    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Numeric nObject = new Numeric();
            string firstBinary = nObject.ToBinary(firstInteger);
            string secondBinary = nObject.ToBinary(secondInteger);

            FloatBinary fObject = new FloatBinary();
            string resultBinary = fObject.AddBinaryFloat(firstBinary, secondBinary);

            double resultDecimal = nObject.ToDecimal(resultBinary);
